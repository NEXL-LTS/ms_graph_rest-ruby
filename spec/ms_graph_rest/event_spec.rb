...
module MsGraphRest
  RSpec.describe 'Event' do
    ...
    describe 'Get instances of recurring message' do
      ...
      before do
        stub_request(:get, "https://graph.microsoft.com/v1.0/me/events/#{event_id}/instances?endDateTime=2023-05-31T10:04:58Z&startDateTime=2023-04-05T10:04:58Z").to_return(status: 200, body: body, headers: {})
      end

      it do
        result = event_query.get_instances(event_id, start_date_time:, end_date_time:)
        ...
        expect(result.first)
          .to have_attributes(original_start_time_zone: "originalStartTimeZone-value",
                              ...
                              i_cal_u_id: '040000008200E00074C5B7101A82E00807E705104AAEFBBC6F67D9010000000000000000100000005D70DF1FCF77AF439519B6F639B957D9',
